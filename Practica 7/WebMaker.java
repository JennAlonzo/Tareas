	...
	*/
	public String imprimirEncabezado() {
		if(pageHeader == null) {
			...
			sb.append("<body>");
			sb.append("<h1>");
			sb.append("Esta es mi pagina web!");
			sb.append("</h1>");
	...
	*/
	public String imprimirCierre() {
		if (this.pageFooter == null) {
			...
			aux.append("Made with WebMaker&trade;. &copy; 2013 - 2014 Facultad de Ingenieria. Algunos derechos reservados");
			aux.append("</p>");
			aux.append("</body>");
			aux.append("</html>");
